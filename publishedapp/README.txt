Make sure to have the following in here (the youtube video links in the README.md demo this)
publish\  [ folder that contains the published .net core app]
DeployToPipeline.ps1  (copy from parent directory into here)
